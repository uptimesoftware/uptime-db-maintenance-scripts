...
--v6 table
-- INSERT #SUPPORT_DBCLEANUP VALUES ('vmware_perf_sample', 'ID < ' + @CUTOFF_SAMPLEID , 0, 0, 0)
--v7 table
-- INSERT #SUPPORT_DBCLEANUP VALUES ('net_device_perf_sample', 'ID < ' + @CUTOFF_SAMPLEID , 0, 0, 0)
